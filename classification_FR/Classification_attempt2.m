...
for isel = 1:length(Nmn_selvec);
    ...
    for ik = 1:Nrep %this loop is for the slop at the same time instance
        ...
        for w_now = [2:10] %we're working at different time_windows

            [FR,label_mat] = selecting_current_timewindow2(mn_feat,w_now,[Ntrials,Nexc],Lw);
            ...
            if w_now == 2
                ...
                FR_test = [FR_test; FR_selected(ind_test,:)];
                Y_test = [Y_test; label_selected(ind_test,:)];
            end

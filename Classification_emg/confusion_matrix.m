...
figure('visible','on');
imagesc(Cmat);colormap(1-gray);caxis([0,1])
...
set(gca,'XTick',1:L,'XTickLabel',classes_names,'YTick',1:L,'YTickLabel',classes_names,'TickLength',[0,0],'FontSize',10,'FontName','Times New Roman');
colorbar;
